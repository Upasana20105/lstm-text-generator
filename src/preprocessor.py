...
class TextPreprocessor:
    ...
    Attributes:
        char_to_idx: Mapping from characters to integer indices.
        idx_to_char: Mapping from integer indices to characters.
    ...
    def clean_text(self, text: str) -> str:
        ...
        Returns:
            Cleaned text with lowercase letters, basic punctuation, and spaces.
        """
        # Convert to lowercase
        text = text.lower()
        
        # Keep only letters, basic punctuation, and whitespace
        # This preserves sentence structure while removing noise
    ...
    def build_vocabulary(self, text: str) -> None:
        ...
        Args:
            text: Cleaned text to extract vocabulary from.
        """
        self._text = text
    ...
    def create_sequences(self, 
        ...
        Uses a sliding window approach to generate overlapping sequences.
        ...
        Returns:
            Tuple of (X, y) where:
                ...
                y: Target characters of shape (num_sequences,)
        """
        if not self._text:
